...
export default function RegisterPage() {
  ...
  if (success) {
    return (
      <div className="min-h-[100dvh] w-full flex bg-[#0A0A0F] items-center justify-center p-6 text-center">
        <div className="vercel-card max-w-sm w-full">
           <div className="w-12 h-12 bg-[#00C896]/10 border border-[#00C896]/20 rounded-xl flex items-center justify-center mx-auto mb-6 text-[#00C896]">
           ...
           <h2 className="text-xl font-bold tracking-tight text-[#F0F0FF] mb-2">Check your email</h2>
           <p className="text-sm text-[#9090A8] leading-relaxed mb-6">
             A secure authentication link was forwarded to <br/>
             <span className="font-mono text-[#F0F0FF] py-1 inline-block">{email}</span>
           </p>
           <Link href="/login" className="btn-secondary w-full block text-sm">
             Return to login
           </Link>
        </div>
      </div>
    ...
    <div className="min-h-[100dvh] w-full flex bg-[#0A0A0F] items-center justify-center p-6 selection:bg-[#6C63FF]/30">
      <div className="w-full max-w-sm">
        ...
        <p className="mt-8 text-center text-sm text-[#9090A8]">
          ...
          <Link href="/login" className="text-[#F0F0FF] hover:text-[#6C63FF] transition-colors font-medium">
            Log in
          </Link>
        </p>
